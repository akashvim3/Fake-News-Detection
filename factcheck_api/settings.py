...
ROOT_URLCONF = 'factcheck_api.urls'
...
WSGI_APPLICATION = 'factcheck_api.wsgi.application'
...
if config('DB_HOST', default=None):
    DATABASES['default'] = {
        ...
        'NAME': config('DB_NAME', default='factcheck_db'),
...
# Model Paths
BERT_MODEL_PATH = config('BERT_MODEL_PATH', default='bert-base-uncased')
DEEPFAKE_MODEL_PATH = config('DEEPFAKE_MODEL_PATH', default='models/deepfake_detector.pth')
